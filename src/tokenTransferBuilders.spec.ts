...
describe("test token transfer builders", () => {
    ...
    it("should work with ESDTNFT transfers (NFT)", () => {
        ...
        assert.equal(
            payload.toString(),
            "ESDTNFTTransfer@4552444a532d333866323439@01@01@8049d639e5a6980d1cd2392abcce41029cda74a1563523a202f09641cc2618f8",
        );
    });
    ...
    it("should work with ESDTNFT transfers (SFT)", () => {
        ...
        assert.equal(
            payload.toString(),
            "ESDTNFTTransfer@53454d492d396566643066@01@05@5e60b9ff2385ea27ba0c3da4689779a8f7364acee1db0ee7bee59ac660a28974",
        );
    });
    ...
    it("should work with Multi ESDTNFT transfers", () => {
        ...
        assert.equal(
            payload.toString(),
            "MultiESDTNFTTransfer@0139472eff6886771a982f3083da5d421f24c29181e63888228dc81ca60d69e1@02@4552444a532d333866323439@01@01@4241522d633830643239@@8ac7230489e80000",
        );
    });
});

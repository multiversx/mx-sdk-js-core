...
describe("test relayed v1 transaction builder", function () {
    ...
    it("should compute relayed v1 transaction", async function () {
        ...
        assert.equal(relayedTxV1.getSignature().toString("hex"), "128e7cdc14c2b9beee2f3ff7a7fa5d1f5ef31a654a0c92e223c90ab28265fa277d306f23a06536248cf9573e828017004fb639617fade4d68a37524aafca710d");
    });

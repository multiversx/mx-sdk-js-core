...
describe.only("ProxyNetworkProvider Tests", () => {
    ...
    it("should send transactions", async () => {
        ...
        const lastTransaction = new Transaction({
            sender: Address.newFromBech32("erd1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qazcccl"),
            receiver: Address.newFromBech32("erd1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qazcccl"),
            gasLimit: 50000n,
            chainID: "D",
        ...
        const transactions = [firstTransaction, invalidTransaction, lastTransaction];
        ...
        const hashes = await proxy.sendTransactions(transactions);
    ...
    it("should simulate transaction", async () => {
        ...
        assert.equal(txOnNetwork.status, new TransactionStatus("success"));
        ...
        assert.equal(txOnNetwork.smartContractResults[0].data, Buffer.from("@6f6b", "base64"));

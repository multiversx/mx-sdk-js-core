...
(function (global, factory) {
    ...
    $root.proto = (function () {
        ...
        proto.Transaction = (function () {
             ...
             * @property {Uint8Array|null} [Relayer] Transaction RelayerAddr
            ...
            Transaction.encode = function encode(message, writer) {
                ...
                if (message.Relayer != null && Object.hasOwnProperty.call(message, "Relayer"))
                    writer.uint32(/* id 14, wireType 2 =*/ 114).bytes(message.Relayer);
                if (message.RelayerSignature != null && Object.hasOwnProperty.call(message, "RelayerSignature"))
                    writer.uint32(/* id 15, wireType 2 =*/ 122).bytes(message.RelayerSignature);
                return writer;
            };
            ...
            Transaction.verify = function verify(message) {
                ...
                if (message.RcvAddr != null && message.hasOwnProperty("RcvAddr"))
                    if (
                        !(
                            (message.RcvAddr && typeof message.RcvAddr.length === "number") ||
                ...
                if (message.RcvUserName != null && message.hasOwnProperty("RcvUserName"))
                    if (
                        !(
                            (message.RcvUserName && typeof message.RcvUserName.length === "number") ||
                ...
                if (message.SndAddr != null && message.hasOwnProperty("SndAddr"))
                    if (
                        !(
                            (message.SndAddr && typeof message.SndAddr.length === "number") ||
                ...
                if (message.SndUserName != null && message.hasOwnProperty("SndUserName"))
                    if (
                        !(
                            (message.SndUserName && typeof message.SndUserName.length === "number") ||
                ...
                if (message.ChainID != null && message.hasOwnProperty("ChainID"))
                    if (
                        !(
                            (message.ChainID && typeof message.ChainID.length === "number") ||
                ...
                if (message.Options != null && message.hasOwnProperty("Options"))
                    if (!$util.isInteger(message.Options)) return "Options: integer expected";
                if (message.GuardianAddr != null && message.hasOwnProperty("GuardianAddr"))
                    if (
                        !(
                            (message.GuardianAddr && typeof message.GuardianAddr.length === "number") ||
                            $util.isString(message.GuardianAddr)
                        )
                    )
                ...
                if (message.GuardianSignature != null && message.hasOwnProperty("GuardianSignature"))
                    if (
                        !(
                            (message.GuardianSignature && typeof message.GuardianSignature.length === "number") ||
                            $util.isString(message.GuardianSignature)
                        )
                    )
                ...
                if (message.Relayer != null && message.hasOwnProperty("Relayer"))
                    if (
                        !(
                            (message.Relayer && typeof message.Relayer.length === "number") ||
                            $util.isString(message.Relayer)
                        )
                    )
                ...
                if (message.RelayerSignature != null && message.hasOwnProperty("RelayerSignature"))
                    if (
                        !(
                            (message.RelayerSignature && typeof message.RelayerSignature.length === "number") ||
                            $util.isString(message.RelayerSignature)
                        )
                    )
            ...
            Transaction.fromObject = function fromObject(object) {
                ...
                if (object.Nonce != null)
                    if ($util.Long) (message.Nonce = $util.Long.fromValue(object.Nonce)).unsigned = true;
                ...
                if (object.RcvAddr != null)
                    if (typeof object.RcvAddr === "string")
                        $util.base64.decode(
                            object.RcvAddr,
                            (message.RcvAddr = $util.newBuffer($util.base64.length(object.RcvAddr))),
                            0,
                        );
                    else if (object.RcvAddr.length >= 0) message.RcvAddr = object.RcvAddr;
                if (object.RcvUserName != null)
                    if (typeof object.RcvUserName === "string")
                        $util.base64.decode(
                            object.RcvUserName,
                            (message.RcvUserName = $util.newBuffer($util.base64.length(object.RcvUserName))),
                            0,
                        );
                    else if (object.RcvUserName.length >= 0) message.RcvUserName = object.RcvUserName;
                if (object.SndAddr != null)
                    if (typeof object.SndAddr === "string")
                        $util.base64.decode(
                            object.SndAddr,
                            (message.SndAddr = $util.newBuffer($util.base64.length(object.SndAddr))),
                            0,
                        );
                    else if (object.SndAddr.length >= 0) message.SndAddr = object.SndAddr;
                if (object.SndUserName != null)
                    if (typeof object.SndUserName === "string")
                        $util.base64.decode(
                            object.SndUserName,
                            (message.SndUserName = $util.newBuffer($util.base64.length(object.SndUserName))),
                            0,
                        );
                    else if (object.SndUserName.length >= 0) message.SndUserName = object.SndUserName;
                if (object.GasPrice != null)
                    if ($util.Long) (message.GasPrice = $util.Long.fromValue(object.GasPrice)).unsigned = true;
                    else if (typeof object.GasPrice === "string") message.GasPrice = parseInt(object.GasPrice, 10);
                    else if (typeof object.GasPrice === "number") message.GasPrice = object.GasPrice;
                ...
                if (object.GasLimit != null)
                    if ($util.Long) (message.GasLimit = $util.Long.fromValue(object.GasLimit)).unsigned = true;
                ...
                if (object.ChainID != null)
                    if (typeof object.ChainID === "string")
                        $util.base64.decode(
                            object.ChainID,
                            (message.ChainID = $util.newBuffer($util.base64.length(object.ChainID))),
                            0,
                        );
                    else if (object.ChainID.length >= 0) message.ChainID = object.ChainID;
                ...
                if (object.GuardianAddr != null)
                    if (typeof object.GuardianAddr === "string")
                        $util.base64.decode(
                            object.GuardianAddr,
                            (message.GuardianAddr = $util.newBuffer($util.base64.length(object.GuardianAddr))),
                            0,
                        );
                    else if (object.GuardianAddr.length >= 0) message.GuardianAddr = object.GuardianAddr;
                if (object.GuardianSignature != null)
                    if (typeof object.GuardianSignature === "string")
                        $util.base64.decode(
                            object.GuardianSignature,
                            (message.GuardianSignature = $util.newBuffer(
                                $util.base64.length(object.GuardianSignature),
                            )),
                            0,
                        );
                    else if (object.GuardianSignature.length >= 0) message.GuardianSignature = object.GuardianSignature;
                if (object.Relayer != null)
                    if (typeof object.Relayer === "string")
                        $util.base64.decode(
                            object.Relayer,
                            (message.Relayer = $util.newBuffer($util.base64.length(object.Relayer))),
                            0,
                        );
                    else if (object.Relayer.length >= 0) message.Relayer = object.Relayer;
                if (object.RelayerSignature != null)
                    if (typeof object.RelayerSignature === "string")
                        $util.base64.decode(
                            object.RelayerSignature,
                            (message.RelayerSignature = $util.newBuffer($util.base64.length(object.RelayerSignature))),
                            0,
                        );
                    else if (object.RelayerSignature.length >= 0) message.RelayerSignature = object.RelayerSignature;
                return message;
            };
            ...
            Transaction.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.Options = 0;
                    if (options.bytes === String) object.GuardianAddr = "";
                    else {
                        object.GuardianAddr = [];
                        if (options.bytes !== Array) object.GuardianAddr = $util.newBuffer(object.GuardianAddr);
                    }
                    ...
                    if (options.bytes === String) object.Relayer = "";
                    else {
                        object.Relayer = [];
                        if (options.bytes !== Array) object.Relayer = $util.newBuffer(object.Relayer);
                    }
                    if (options.bytes === String) object.RelayerSignature = "";
                    else {
                        object.RelayerSignature = [];
                        if (options.bytes !== Array) object.RelayerSignature = $util.newBuffer(object.RelayerSignature);
                    }
                }
                if (message.Nonce != null && message.hasOwnProperty("Nonce"))
                    if (typeof message.Nonce === "number")
                        ...
                        object.Nonce =
                            options.longs === String
                                ...
                                : options.longs === Number
                                  ? new $util.LongBits(message.Nonce.low >>> 0, message.Nonce.high >>> 0).toNumber(true)
                                  : message.Nonce;
                if (message.Value != null && message.hasOwnProperty("Value"))
                    object.Value =
                ...
                if (message.RcvAddr != null && message.hasOwnProperty("RcvAddr"))
                    object.RcvAddr =
                        options.bytes === String
                            ? $util.base64.encode(message.RcvAddr, 0, message.RcvAddr.length)
                            : options.bytes === Array
                ...
                if (message.RcvUserName != null && message.hasOwnProperty("RcvUserName"))
                    object.RcvUserName =
                        options.bytes === String
                            ? $util.base64.encode(message.RcvUserName, 0, message.RcvUserName.length)
                            : options.bytes === Array
                ...
                if (message.SndAddr != null && message.hasOwnProperty("SndAddr"))
                    object.SndAddr =
                        options.bytes === String
                            ? $util.base64.encode(message.SndAddr, 0, message.SndAddr.length)
                            : options.bytes === Array
                ...
                if (message.SndUserName != null && message.hasOwnProperty("SndUserName"))
                    object.SndUserName =
                        options.bytes === String
                            ? $util.base64.encode(message.SndUserName, 0, message.SndUserName.length)
                            : options.bytes === Array
                ...
                if (message.ChainID != null && message.hasOwnProperty("ChainID"))
                    object.ChainID =
                        options.bytes === String
                            ? $util.base64.encode(message.ChainID, 0, message.ChainID.length)
                            : options.bytes === Array
                ...
                if (message.GuardianAddr != null && message.hasOwnProperty("GuardianAddr"))
                    object.GuardianAddr =
                        options.bytes === String
                            ? $util.base64.encode(message.GuardianAddr, 0, message.GuardianAddr.length)
                            : options.bytes === Array
                              ? Array.prototype.slice.call(message.GuardianAddr)
                              : message.GuardianAddr;
                if (message.GuardianSignature != null && message.hasOwnProperty("GuardianSignature"))
                    object.GuardianSignature =
                        options.bytes === String
                            ? $util.base64.encode(message.GuardianSignature, 0, message.GuardianSignature.length)
                            : options.bytes === Array
                              ? Array.prototype.slice.call(message.GuardianSignature)
                              : message.GuardianSignature;
                if (message.Relayer != null && message.hasOwnProperty("Relayer"))
                    object.Relayer =
                        options.bytes === String
                            ? $util.base64.encode(message.Relayer, 0, message.Relayer.length)
                            : options.bytes === Array
                              ? Array.prototype.slice.call(message.Relayer)
                              : message.Relayer;
                if (message.RelayerSignature != null && message.hasOwnProperty("RelayerSignature"))
                    object.RelayerSignature =
                        options.bytes === String
                            ? $util.base64.encode(message.RelayerSignature, 0, message.RelayerSignature.length)
                            : options.bytes === Array
                              ? Array.prototype.slice.call(message.RelayerSignature)
                              : message.RelayerSignature;
                return object;
            };

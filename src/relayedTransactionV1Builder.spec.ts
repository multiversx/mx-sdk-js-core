...
describe("test relayed v1 transaction builder", function () {
    ...
    it("should compute guarded inner Tx - relayed v1 transaction", async function () {
        ...
        assert.equal(relayedTxV1.getSignature().hex(), "f3db6318406f01ef807f04039e33563f97c2eabc1c8a59b6e412429725f03242cba679c717b734cb06859ef8e14349edf1db5eb1a9b3d36697b922475ae7ea07");
    });
    ...
    it("should compute guarded inner tx and guarded relayed v1 transaction", async function () {
        ...
        assert.equal(relayedTxV1.getSignature().hex(), "15fe39045685625d0f1742e34ba7679d225d49fc1f1f2ab363b7e78beddb8d278d11f5658a0d0e996d28ba77c49bc6d614b62a4eb7e74f363546ecaa2a84d905");
    });
});

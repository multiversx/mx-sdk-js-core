...
out-browser-tests/erdjs-tests-mainnet.js: out-tests
	npx browserify $(shell find out-tests -type f -name '*.js' ! -name '*.spec.*') $(shell find out-tests -type f -name '*.main.net.spec.js') --require buffer/:buffer -o out-browser-tests/erdjs-tests-mainnet.js --standalone erdjs-tests -p esmify
